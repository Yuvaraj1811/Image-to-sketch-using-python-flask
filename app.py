...
UPLOAD_FOLDER = r"C:\\Users\Admin\Desktop\\Yuvaraj\sketch\static\\uploads"
...
def sketch():
    ...
    if file and allowed_file(file.filename):
        ...
        return render_template('index.php',org_img_name=filename,sketch_img_name=sketch_img_name)
